...
function unOrderlist() {
    ...
    // acesseing the linkedlist class file
    ...
    unorder.show();
    // for displaying that array we have given data
    ...
    else 
    {
        ...
        //calling  elements by search method present in linkedlist class
         {
            unorder.remove(answer);
      //removing element wht you are repeated that element presnt in string 
        }
        else 
        {
            unorder.add(answer);
    ...
    // it will acessing the writefile in the util class
